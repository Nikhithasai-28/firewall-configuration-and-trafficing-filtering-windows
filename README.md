# firewall-configuration-and-trafficing-filtering-windows
...
or
Open Command Prompt / PowerShell as Administr

2. List Current Firewall Rules
Use the following command to display all existing rules:

3. Add a Rule to Block Inbound Traffic on Port 23 (Telnet)
Add a new rule to block inbound connections on TCP port 2

4. Test the Rule
Try to connect to port 23 locally to verify the rule works:

telnet localhost 23
Expected Result: Connection fails or is ref
